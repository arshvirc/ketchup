...
class Model() {
        ...
        completeButton.setOnAction { obs ->
            run {
                ...
                if (source.graphic.id.toInt() == 1) {
                    ...
                    this.removeCompletedItem(itemId)
    ...
    private fun removeCompletedItem( completedID: String) {
        ...
        uiListOfAllItems.removeAll(tempList)
        uiListOfAllItems.addAll(tempList)
        print(uiListOfAllItems.lastIndex)
    }
